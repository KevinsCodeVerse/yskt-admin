...
<template>
	<div class="middle-container" v-loading="loading">
		<jat-fillter :option="filterOptions" v-model="filterData" @searchFilter="searchFilter"
			...
			<span slot="parentId">
				<el-select style="width: 100%;" v-model="filterData.parentId" filterable remote size="small" clearable
					placeholder="添加人(可根据名称或手机号进行搜索)" :remote-method="remoteMethod" :loading="remoteLoading">
