...
<template>
	<div class="middle-container" v-loading="loading">
		...
		<BasicTable :columns="table.columns" :headerOperates="headerOperates" :operates="operates" operateWidth="280px"
			:data="table.data" :pageSize="table.pageSize" :currentPage="table.currentPage" :total="table.total"
			...
			getList() {
				...
				request.post({
					...
					params: {
						...
						createStartTime: createTime && createTime.length > 0 ? createTime[0] : "",
						createEndTime: createTime && createTime.length > 0 ? createTime[1] : "",
