		...
		<el-dialog
			...
			<el-form label-width="100px">
				<el-form-item label="原密码：">
					<el-input @keyup.enter.native="submit" type="password" placeholder="原密码" v-model="formData.oldPassword" show-password></el-input>
				</el-form-item>
				<el-form-item label="新密码：">
					<el-input @keyup.enter.native="submit" type="password" placeholder="新密码" v-model="formData.newPassword" show-password></el-input>
				</el-form-item>
				<el-form-item label="确认密码：">
					<el-input @keyup.enter.native="submit" type="password" placeholder="确认密码" v-model="againPassword" show-password></el-input>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			submit(){
				...
				this.$request.post({
					url: '/merchant/merchantInfo/updatePwd',
					params: {
						newPassword,
						oldPassword,
						verifyCode,
